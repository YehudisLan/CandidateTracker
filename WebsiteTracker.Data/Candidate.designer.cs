...
namespace WebsiteTracker.Data
{
	...
	public partial class CandidateDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteCandidate(Candidate instance);
		...
		public CandidateDataContext() : 
				base(global::WebsiteTracker.Data.Properties.Settings.Default.CandidateTrackerConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public CandidateDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public CandidateDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public CandidateDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public CandidateDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnStatusChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Notes", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		public string Notes
		{
			get
			{
